...
/* @Configuration 이라고 하면 설정파일을 만들기 위한 어노테이션 or Bean 을 등록하기 위한 어노테이션
   이걸 쓰면 JpaConfig 클래스는 Configuration bean 이 된다.
*  간단히 말해서 @Configuration 달아놓으면 시스템이 이거 설정파일이다 , Bean으로 등록해 라는 뜻.
*
* */
@Configuration
...
jpa auditing 이란 : Spring Data jpa 에서 자동으로 값을 넣어주는 기능
   Jpa 에서 자동으로 세틍하게 해줄때 사용하는 기능인데, 특정 데이터를 보고 있다가 생성, 수정되면 자동으로 값을 넣어주는 기능
* */
@EnableJpaAuditing
public class JpaConfig {
    ...
    public AuditorAware<String> auditorAware(){
        ...
        //TODO: 나중에 스프링 시큐리티로 인증기능 붙일때 수정 필요.
    }
